...
void deliver(vector<vector<int>> &graph, vector<bool> &visited, int start, vector<bool> &delivered, int day)
{
...
int main()
{
    ...
    for (int i = 0; i < n - 1; ++i)
    {
        deliver(graph, visited, startPosition, delivered, i + 1);
